...
class CondorcetElection : public RationalElection {
    public:
         ...
         *
         * Initializes all of the private members to default values and 
         * initializes the candidates and votes to empty lists.
         */
        CondorcetElection();
        /**
    ...
    public:
         ...
         *
         * @return A map containing all of the candidates within the election 
         * and the number of votes they possess or an empty map if the votes are
         * uncounted..
         */
